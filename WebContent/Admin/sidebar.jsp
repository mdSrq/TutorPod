<section class="sidebar">
        ...
        <div class="sidebar__footer">
            <a href="../" class="sidebar__footer_icon" title="TutorPod FrontEnd"><img src="../images/marketplace-vector.svg" alt=""></a>
            <a href="../AdminController?cmd=logout" class="sidebar__footer_icon" title="Log Out"><img src="../images/logout-vector.svg" alt=""></a>
        </div>
</section>