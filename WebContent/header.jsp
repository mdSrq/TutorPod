...
<body>
	<header class="header" id="header">
		<nav class="container flex flex-jc-sb flex-ai-c">
			<a href="/" class="header__logo flex flex-ai-c"> <img
				src="./images/TutorPod1.svg" alt="TutorPod" /> <span
				class="header__logo_title">Tutor<span
					class="header__logo_title_part">Pod</span>
			</span>
			</a> <a href="#" id="btnHamburger" class="header__menu hide-for-desktop">
				<span></span> <span></span> <span></span>
			</a>
			<div class="header__links hide-for-mobile">
				<a href="#" class="underlined header__links_dropdown">Subjects <span
					class="dropdown-arrow">></span></a> <a href="#" class="underlined">Apply
					to Teach</a> <a href="#" class="underlined">Search Tutors</a> <a
					href="#" class="underlined">Study Resources</a>
			...
			<div class="header-controls">
				<div class="header-controls__dash-menu">
					<a href="#"><img src="./images/dash_menu.png" alt=""></a>
				</div>
				...
				<div class="header-controls__notifications">
					...
					<div class="notifications scrollable" tabindex="97">
						<div class="notifications__header">
							<span class="notifications__header_title">Notifications</span> <a
								href="#" class="notifications__header_link_l" onclick="markAllAsSeen()">Mark all as
		...
		<div class="header__overlay_menu hide-for-desktop toggle-on">
			<a href="http://">Apply to Teach</a> <a href="#">Search Tutors</a> <a
				href="#">Study Resources</a>
			<%
			if (session.getAttribute("USER") == null) {
			%>
	...
	<script>
        ...
        $(".sidebar").focusout(function(){
            if($(".header-controls__dash-menu :hover").length>0){
                return;
            }
            $(".overlay-background").remove();
            $(".sidebar").removeClass("slide-in");
        ...
        $(".notifications").focusout(() => {
            if ($(".notifications a:hover").length > 0 || $(".header-controls__notifications:hover").length >
                0) {
                return;
            }
            $(".notifications").removeAttr("style");
        ...
        $(".nav-dd").focusout(function () {
            if ($(".nav-dd_subject" + ":hover").length || $(".header-controls__menu img:hover").length) {
                return;
            }
            $(".header-controls__menu > .nav-dd").remove();
            $(".overlay-background").remove();
        ...
        function clickedNotification(notification_id){
        	$.ajax({
                ...
                success: function(response){
                    $("#notif_"+notification_id).css({"font-weight":"normal","color":"#222"});
                }
            });
        }
